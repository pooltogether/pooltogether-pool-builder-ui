...
export function Input(props) {
  ...
  const defaultClasses = 'text-white font-headline border-2 border-transparent bg-purple-1200 rounded-full focus:outline-none focus:outline-none leading-none px-6 py-2 lg:py-2'
