...
export const TxMessage = (props) => {
  ...
  return <>
    {txInFlight && <>
      ...
      >
        <div
          className='font-bold rounded-full mb-4 text-white text-sm sm:text-base lg:text-lg uppercase px-2 py-1 bg-purple-900'
        >
          Transaction status
        </div>
        ...
        {txInWallet && <>
          <div
            className='mb-2 text-orange-400 text-base'
          >
