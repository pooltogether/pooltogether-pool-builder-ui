  ...
  return (
    <Card>
      ...
      <InputLabel
        ...
        description='Provide a name and ticker symbol for the ERC20 token that will be created and used as the pools tickets.'
      >
      ...
      <Collapse title='Advanced Settings' className='mt-4 sm:mt-8'>
        <InputLabel
          ...
          description='Provide a name and ticker symbol for the ERC20 token that will be created and used as the pools sposnorship tickets. Sponsorship tickets are not eligible to win prizes.'
        >
